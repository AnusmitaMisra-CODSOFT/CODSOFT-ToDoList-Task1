...
if _name_ == "_main_":  
    ...
    # setting the background color to Light green  
    guiWindow.configure(bg = "Light green")  
    ...
    header_frame = tk.Frame(guiWindow, bg = "Light green")  
    functions_frame = tk.Frame(guiWindow, bg = "Light green")  
    listbox_frame = tk.Frame(guiWindow, bg = "Light green")  
